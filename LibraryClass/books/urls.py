...
urlpatterns = [
    ...
    path('view',views.ViewbookView.as_view(),name='view_book'),
    path('add1',views.AddbookView1.as_view(),name='add_book1'),
    path('detail/<int:i>',views.DetailView.as_view(),name='detail'),
    path('edit/<int:i>',views.EditView.as_view(),name='edit'),
    path('delete/<int:i>',views.DeletebookView.as_view(),name='delete'),
